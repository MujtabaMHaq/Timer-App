...
function start(ele) {
    ...
    var bas = setInterval(function () {
        ...
        if (time == 0) {
            ...
            btn.style.border = '2px solid rgb(84,180,53)';
            ...
            counter.innerHTML = `${hours}<span class="time">Hrs : </span>${minutes}<span class="time">Mins : </span>${seconds}<span class="time">Secs</span>`
